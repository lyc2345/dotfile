...
(( $+functions[compdef] )) && compdef _git ggpnp=git-checkout
...
(( $+functions[compdef] )) && compdef _git gccd=git-clone
...
(( $+functions[compdef] )) && compdef _git gdv=git-diff
...
(( $+functions[compdef] )) && compdef _git gdnolock=git-diff
...
(( $+functions[compdef] )) && compdef _git ggu=git-pull
...
(( $+functions[compdef] )) && compdef _git ggl=git-pull

alias gluc='git pull origin $(git_current_branch)'
alias glum='git pull origin $(git_main_branch)'
alias gp='git push'
...
(( $+functions[compdef] )) && compdef _git ggf=git-push
...
(( $+functions[compdef] )) && compdef _git ggfl=git-push
...
(( $+functions[compdef] )) && compdef _git ggp=git-push
...
alias grbum='git rebase origin/$(git_main_branch)'
