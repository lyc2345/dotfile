# Generated by Powerlevel10k configuration wizard on 2020-03-25 at 17:41 CST.
...
echo "loaded config: .zsh/p10k.zsh"
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_NODE_VERSION_VISUAL_IDENTIFIER_EXPANSION='⬢ proj-node'
